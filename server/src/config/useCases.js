...
const useCases = [
  ...
  { code: 'LIB-001', name: 'Add Book to Catalog', module: MODULES.LIBRARY, description: 'Register a new book, blocked if its catalog ID already exists.', isoClause: '8.5.1', regulatoryClause: 'INST-POL-LIB §1.1 (placeholder)', guardRules: ['assertDuplicateCatalogEntry'] },
  { code: 'LIB-002', name: 'Submit/Approve Loan Request', module: MODULES.LIBRARY, description: 'Learner requests a book on loan; approval issues the loan.', isoClause: '8.2.1', regulatoryClause: 'INST-POL-LIB §2.1 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'LIB-003', name: 'Issue and Return Loan', module: MODULES.LIBRARY, description: 'Issue a book on loan; return closes the loan and auto-calculates an overdue fine (return workflow corresponds to external ref UC-900-02-02).', isoClause: '8.5.1', regulatoryClause: 'INST-POL-LIB §2.2 (placeholder)', guardRules: ['assertNoOverdueLoans', 'assertBookNotDamaged'] },
  { code: 'LIB-004', name: 'Reserve Book Slot', module: MODULES.LIBRARY, description: 'Reserve a book for a slot of at most 2 hours, blocked past 2 active reservations.', isoClause: '8.5.1', regulatoryClause: 'INST-POL-LIB §3.1 (placeholder)', guardRules: ['assertReservationLimit'] },
  { code: 'LIB-005', name: 'Submit Binding Request', module: MODULES.LIBRARY, description: 'Send a book for binding/repair, taking it out of circulation until complete.', isoClause: '8.5.4', regulatoryClause: 'INST-POL-LIB §4.1 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'LIB-006', name: 'Record Overdue Fine Payment/Waiver', module: MODULES.LIBRARY, description: 'Settle or waive a fine auto-calculated from an overdue return.', isoClause: '8.2.1', regulatoryClause: 'INST-POL-LIB §5.1 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'LIB-007', name: 'Generate Overdue Loan Report', module: MODULES.LIBRARY, description: 'Query active loans past their due date, with computed days overdue.', isoClause: '9.1.3', regulatoryClause: 'INST-POL-LIB §6.1 (placeholder)', guardRules: [] },
];
