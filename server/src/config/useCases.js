...
const useCases = [
  ...
  { code: 'HR-002', name: 'Submit Leave Request', module: MODULES.HR, description: 'Staff member submits a request to take leave.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §2.1 (placeholder)', guardRules: ['assertLeaveBalance'] },
  { code: 'HR-003', name: 'Approve Leave Request', module: MODULES.HR, description: 'Manager approves a submitted leave request.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §2.2 (placeholder)', guardRules: ['assertLeaveBalance', 'ensureStatusTransitionAllowed'] },
  ...
  // --- HR (RecruitmentRequisition, JobApplication, EmploymentContract, LeaveRequest, MedicalClearance, PropertyClearance, TrainingEnrollment, BiometricEnrollment) ---
  { code: 'UC-ADMIN-HR-001', name: 'Submit/Approve Recruitment Requisition', module: MODULES.HR, description: 'Request headcount for a role and approve it to open for applications.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §3.1 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'UC-ADMIN-HR-002', name: 'Submit/Shortlist/Hire Job Application', module: MODULES.HR, description: 'Candidate applies against a requisition and moves through shortlisting to hire.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §3.2 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'UC-ADMIN-HR-003', name: 'Sign/Activate Employment Contract', module: MODULES.HR, description: 'Draft, sign and activate an employment contract for a hired candidate.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §3.3 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'UC-ADMIN-HR-004', name: 'Submit/Approve Leave Request', module: MODULES.HR, description: 'Submit a leave request against a leave balance, blocked on insufficient balance or a pending clearance hold.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §2.5 (placeholder)', guardRules: ['assertLeaveBalance', 'assertNoActiveClearanceHold'] },
  { code: 'UC-ADMIN-HR-005', name: 'Process Medical Clearance', module: MODULES.HR, description: 'Clear or reject a pending medical clearance for an employee.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §4.1 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'UC-ADMIN-HR-006', name: 'Process Property Clearance', module: MODULES.HR, description: 'Clear or reject a pending property clearance for an employee.', isoClause: '7.1.2', regulatoryClause: 'INST-POL-HR §4.2 (placeholder)', guardRules: ['ensureStatusTransitionAllowed'] },
  { code: 'UC-ADMIN-HR-007', name: 'Enroll in Training', module: MODULES.HR, description: 'Enroll an employee into a training schedule, blocked without an active signed contract or with a pending clearance hold.', isoClause: '7.2.1', regulatoryClause: 'INST-POL-HR §5.1 (placeholder)', guardRules: ['assertContractPrerequisite', 'assertNoActiveClearanceHold'] },
  { code: 'UC-ADMIN-HR-008', name: 'Enroll Biometric', module: MODULES.HR, description: 'Register an employee\'s biometric hash, blocked if it already belongs to another active employee.', isoClause: '7.1.3', regulatoryClause: 'INST-POL-HR §6.1 (placeholder)', guardRules: ['assertBiometricUnique'] },
];
